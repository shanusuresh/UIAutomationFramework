...
import com.weathershopper.enums.LogType;
import com.weathershopper.utils.PropertyFileUtil;
import com.weathershopper.utils.ScreenshotUtils;
...
public final class FrameworkLogger {
    ...
    public static void log(LogType status, String message) {
        if (!PropertyFileUtil.get(ConfigProperties.PASSEDSTEPSSCREENSHOTS).equalsIgnoreCase("yes")) {
